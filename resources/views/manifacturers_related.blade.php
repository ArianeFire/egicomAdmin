@extends('master')
@section('content')
@if(isset($manifacturers->products) && "products" == $table)
    <div class="row">
    <div class="col-md-4">
    ...
    <div class="col-md-5">
        {{ session(['defaultSelect' => $manifacturers->id]) }}
        <h4 class="text-danger"><b>Manifacturers : {{$manifacturers->name}}</b></h4>
    </div>
</div>
...
<table class="table table-striped">
    ...
    <tbody>
    @forelse($manifacturers->products_paginated as  $products)
    <tr>
...
{!!$manifacturers->products_paginated->links()!!}    @else
