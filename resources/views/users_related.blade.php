@extends('master')
@section('content')
@if(isset($users->carts) && "carts" == $table)
    <div class="row">
    <div class="col-md-4">
    ...
    <div class="col-md-5">
        {{ session(['defaultSelect' => $users->id]) }}
        <h4 class="text-danger"><b>Users : {{$users->name}}</b></h4>
    </div>
</div>
...
<table class="table table-striped">
    ...
    <tbody>
    @forelse($users->carts_paginated as  $carts)
    <tr>
...
{!!$users->carts_paginated->links()!!}    @else
